 ...
 */
export declare const entryPointTransformFactory: (initTsConfig: Transform, analyzeTsSources: Transform, renderStylesheets: Transform, renderTemplates: Transform, transformTsSources: Transform, compileTs: Transform, writeBundles: Transform, relocateSourceMaps: Transform, writePackage: Transform) => Transform;
